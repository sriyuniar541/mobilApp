...
<div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name='merek' id="merek" value="{{$data->merek}}">
    </div>
</div>
...
<div class="mb-3 row">
    <label for="nomor_plat" class="col-sm-2 col-form-label">Nomor Plat</label>
    <div class="col-sm-10">
...
<div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="number" placeholder='Rp........' class="form-control" name='sewa_perhari' id="harga" value="{{$data->sewa_perhari}}">
    </div>
</div>
